...
export const invitationData = {
  ...
  groom: {
    honorific:       "चि.",
    firstName:       "हृतिक",
    fullName:        "हृतिक गुप्ता",
    fatherHonorific: "श्री",
    fatherName:      "Dummy Father Full Name (वर पक्ष)",
    motherHonorific: "श्रीमती",
    motherName:      "Dummy Mother Full Name (वर पक्ष)",
  ...
  bride: {
    honorific:       "सौ.",
    firstName:       "चाँदा",
    fullName:        "चाँदा गुप्ता",
    fatherHonorific: "श्री",
    fatherName:      "Dummy Father Full Name (वधू पक्ष)",
    motherHonorific: "श्रीमती",
    motherName:      "Dummy Mother Full Name (वधू पक्ष)",
    familyName:      "गुप्ता परिवार",
...
export const photos = [
  { id: "p1", src: "/photos/IMG20240928120151.jpg", caption: "हल्दी समारोह" },
  { id: "p2", src: "/photos/IMG20241002144246.jpg", caption: "संगीत रात्रि" },
  { id: "p3", src: "/photos/IMG20241006074943.jpg", caption: "बारात प्रस्थान" },
...
export const venue = {
  name:        "श्री राम विवाह मंडप",
  address:     "मारवाड़ी विवाह भवन, NH-105, सर्वदेवमयी माता मंदिर के सामने, जयनगर, मधुबनी, बिहार — 847226",
...
export const contactLabels = {
  ...
  body:             "आपकी उपस्थिति हमारे लिए अनमोल है। अपनी सहभागिता की पुष्टि करें या अपना आशीर्वाद भेजें — इस विशेष दिन को आपके साथ मनाकर हम अत्यंत प्रसन्न होंगे।",
  namePlaceholder:  "अपना पूरा नाम लिखें",
  nameLabel:        "आपका नाम",
  attendingLabel:   "क्या आप आएंगे?",
  attendingDefault: "कृपया चुनें…",
  attendingOptions: [
    { value: "yes-all",       label: "हाँ — सभी आयोजनों में आऊँगा/आऊँगी" },
    { value: "yes-wedding",   label: "हाँ — केवल विवाह दिवस" },
    { value: "yes-reception", label: "हाँ — केवल रिसेप्शन" },
    { value: "no",            label: "खेद है, नहीं आ सकता/सकती" },
  ],
